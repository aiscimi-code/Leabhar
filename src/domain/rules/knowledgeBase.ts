...
const SOURCES: Array<{ path: string; ingest: IngestFn }> = [
  ...
  { path: 'docs/statutes/vatca-2010-revised/s067.md', ingest: ingestVatcaRevisedSection },
  { path: 'docs/statutes/vatca-2010-revised/s069.md', ingest: ingestVatcaRevisedSection },
  { path: 'docs/statutes/vatca-2010-revised/s070.md', ingest: ingestVatcaRevisedSection },
