...
> The original project brief for Leabhar. The living design source of truth
> is [docs/DOMAIN_MODEL.md](DOMAIN_MODEL.md); this document is preserved as
> the specification the project was built against.
